    ...
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-cyan-50 to-sky-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <div className="bg-white rounded-3xl shadow-lg border border-blue-100 overflow-hidden">
          <div className="relative h-36 bg-linear-to-r from-blue-400 via-sky-400 to-cyan-400">
              ...
              <label className="cursor-pointer group block relative">
                ...
                <div className="w-32 h-32 rounded-full overflow-hidden ring-8 ring-white shadow-2xl transition-all group-hover:ring-blue-100">
                  {form.avatar ? (
                    ...
                    <div className="w-full h-full bg-linear-to-br from-blue-500 to-sky-500 flex items-center justify-center text-5xl font-bold text-white">
                      {getInitial()}
                    </div>
                  )}
                </div>
          ...
          <div className="pt-20 px-8 pb-12">
            <div className="space-y-7">
              ...
              <div>
                ...
                <input type="email" value={form.email} className={inputClasses} readOnly />
              </div>
